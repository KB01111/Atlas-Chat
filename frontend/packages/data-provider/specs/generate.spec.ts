  ...
  it("should generate a schema for array settings", () => {
    ...
    if (!result.success) {
      ...
      const issues = result.error.issues.filter(
        (issue) =>
          issue.path.includes("testArray") && issue.code === "too_small",
      );
...
describe("validateSettingDefinitions", () => {
  ...
  test("should correctly handle columnSpan defaulting based on columns", () => {
    ...
    expect(() =>
      validateSettingDefinitions(settingsWithColumnAdjustment),
    ).not.toThrow();
  });
  ...
  test("label should default to key if not explicitly set", () => {
    ...
    expect(() =>
      validateSettingDefinitions(settingsWithDefaultLabel),
    ).not.toThrow();
  ...
  test("should throw error for negative minText or maxText", () => {
    ...
    expect(() =>
      validateSettingDefinitions(settingsWithNegativeTextLimits),
    ).toThrow(ZodError);
  });
  ...
  test('should throw error for optionType "conversation" not matching schema', () => {
    ...
    expect(() =>
      validateSettingDefinitions(settingsWithInvalidConversationOptionType),
    ).toThrow(ZodError);
  });
  ...
  test("should validate minTags and maxTags constraints", () => {
    ...
    expect(() =>
      validateSettingDefinitions(settingsWithTagsConstraints),
    ).toThrow(ZodError);
  });
  ...
  test("should ensure default values for tags are arrays", () => {
    ...
    expect(() =>
      validateSettingDefinitions(settingsWithInvalidDefaultForTags),
    ).toThrow(ZodError);
  });
  ...
  test("array settings without defaults should not throw if constraints are met", () => {
    ...
    expect(() =>
      validateSettingDefinitions(settingsWithNoDefaultButValidTags),
    ).not.toThrow();
  });
  ...
  test("should ensure maxTags is respected for default array values", () => {
    ...
    expect(() => validateSettingDefinitions(settingsExceedingMaxTags)).toThrow(
      ZodError,
    );
  });
});
...
describe("Settings Validation and Schema Generation", () => {
  ...
  test("validateSettingDefinitions does not throw for valid configuration", () => {
    expect(() =>
      validateSettingDefinitions(settingsConfiguration),
    ).not.toThrow();
  });
  ...
  test("validateSettingDefinitions throws for invalid type in settings", () => {
    ...
    expect(() =>
      validateSettingDefinitions(
        settingsWithInvalidType as SettingsConfiguration,
      ),
    ).toThrow();
  });
  ...
  test("validateSettingDefinitions throws for missing required fields", () => {
    ...
    expect(() =>
      validateSettingDefinitions(
        settingsMissingRequiredField as SettingsConfiguration,
      ),
    ).toThrow();
  });
  ...
  test("validateSettingDefinitions throws for default value out of range", () => {
    ...
    expect(() =>
      validateSettingDefinitions(settingsOutOfRange as SettingsConfiguration),
    ).toThrow();
  });
  ...
  test("validateSettingDefinitions throws for enum setting with incorrect default", () => {
    ...
    expect(() =>
      validateSettingDefinitions(
        settingsWithIncorrectEnumDefault as SettingsConfiguration,
      ),
    ).toThrow();
  });
