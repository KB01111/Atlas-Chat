...
export declare const useAbortRequestWithMessage: () => UseMutationResult<
  void,
  Error,
  {
    endpoint: string;
...
>;
export declare const useGetUserQuery: (
  config?: UseQueryOptions<t.TUser>,
) => QueryObserverResult<t.TUser>;
export declare const useGetMessagesByConvoId: (
  id: string,
  config?: UseQueryOptions<t.TMessage[]>,
) => QueryObserverResult<t.TMessage[]>;
export declare const useGetConversationByIdQuery: (
  id: string,
  config?: UseQueryOptions<t.TConversation>,
) => QueryObserverResult<t.TConversation>;
export declare const useGetConversationByIdMutation: (
  id: string,
) => UseMutationResult<t.TConversation>;
export declare const useUpdateConversationMutation: (
  id: string,
) => UseMutationResult<
  ...
  unknown
>;
export declare const useDeleteConversationMutation: (
  id?: string,
) => UseMutationResult<
...
export declare const useUpdatePresetMutation: () => UseMutationResult<
  ...
  unknown
>;
export declare const useGetPresetsQuery: (
...
export declare const useDeletePresetMutation: () => UseMutationResult<
  ...
  unknown
>;
export declare const useSearchQuery: (
  searchQuery: string,
  pageNumber: string,
  config?: UseQueryOptions<t.TSearchResults>,
) => QueryObserverResult<t.TSearchResults>;
export declare const useUpdateTokenCountMutation: () => UseMutationResult<
  t.TUpdateTokenCountResponse,
  unknown,
  string,
  unknown
>;
export declare const useLoginUserMutation: () => UseMutationResult<
  t.TLoginResponse,
  unknown,
  t.TLoginUser,
  unknown
>;
export declare const useRegisterUserMutation: () => UseMutationResult<
  unknown,
  unknown,
  t.TRegisterUser,
  unknown
...
export declare const useRefreshTokenMutation: () => UseMutationResult<
  t.TRefreshTokenResponse,
  unknown,
  unknown,
  unknown
>;
export declare const useRequestPasswordResetMutation: () => UseMutationResult<
  t.TRequestPasswordResetResponse,
  unknown,
  t.TRequestPasswordReset,
  unknown
>;
export declare const useResetPasswordMutation: () => UseMutationResult<
  unknown,
  unknown,
  t.TResetPassword,
  unknown
...
export declare const useAvailablePluginsQuery: () => QueryObserverResult<
  t.TPlugin[]
>;
export declare const useUpdateUserPluginsMutation: () => UseMutationResult<
  t.TUser,
  unknown,
