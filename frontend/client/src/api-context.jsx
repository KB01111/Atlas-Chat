...
export const ApiProvider = ({ children }) => {
  ...
  const refreshAgents = async () => {
    try {
      ...
      return { success: false, error: error.detail || 'Failed to refresh agents' };
    }
  };
  ...
  const executeCode = async (code, language, threadId) => {
    ...
    try {
      ...
      return { success: false, error: error.detail || 'Failed to execute code' };
    }
  };
  ...
  const installPackages = async (packages, language, threadId) => {
    ...
    try {
      ...
      return { success: false, error: error.detail || 'Failed to install packages' };
    }
  };
