...
import { FiUsers, FiUserPlus, FiCode, FiList, FiCheckCircle, FiAlertCircle } from 'react-icons/fi';
...
const TeamChatInterface = ({
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'in_progress':
        return <div className="status-icon in-progress"><div className="spinner"></div></div>;
      default:
      ...
      <div className="team-chat-main">
        <div className="chat-messages">
          {messages.map((message, index) => (
            ...
            >
              <div className="message-sender">{message.sender === 'user' ? 'You' : getAgentName(message.sender)}</div>
