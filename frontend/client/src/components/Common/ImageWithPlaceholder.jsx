  ...
  return (
    ...
    >
      ...
      {!isLoaded && !hasError && (
        ...
        >
          <div
            className="loading-pulse" // Ensure this class is defined in your global CSS or a CSS module
            style={{
              width: '30%',
              height: '30%',
              borderRadius: '50%',
              background: 'rgba(255, 255, 255, 0.7)',
              // animation: 'pulse 1.5s infinite ease-in-out', // Remove animation from inline style
            }}
          />
        </div>
      )}
      ...
      <img
        ...
        {...rest}
      />
      {/* Removed <style jsx> block - Add pulse animation to CSS */}
    </div>
  );
};
