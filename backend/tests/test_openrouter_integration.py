...
class TestOpenRouterClient(unittest.TestCase):
    ...
    def test_chat_completion(self, mock_post):
        ...
        response = loop.run_until_complete(self.client.chat_completion(
...
class TestOpenRouterSDKAgent(unittest.TestCase):
    ...
    def test_execute(self):
        ...
        loop = asyncio.new_event_loop()
        asyncio.set_event_loop(loop)
        response = loop.run_until_complete(self.agent.execute(
...
class TestOpenRouterLangGraphAgent(unittest.TestCase):
    ...
    def test_create_graph(self, mock_state_graph):
        ...
        loop = asyncio.new_event_loop()
        asyncio.set_event_loop(loop)
        result = loop.run_until_complete(self.agent.create_graph(
            agent_config=TEST_AGENT_CONFIG,
            tools=TEST_TOOLS
        ))
...
class TestOpenRouterGraphitiIntegration(unittest.TestCase):
    ...
    def test_add_conversation_to_graphiti(self):
        ...
        loop = asyncio.new_event_loop()
        asyncio.set_event_loop(loop)
        episode_id = loop.run_until_complete(self.integration.add_conversation_to_graphiti(
    ...
    def test_search_graphiti_for_context(self):
        ...
        loop = asyncio.new_event_loop()
        asyncio.set_event_loop(loop)
        results = loop.run_until_complete(self.integration.search_graphiti_for_context(
    ...
    def test_enhance_messages_with_graphiti_context(self):
        ...
        loop = asyncio.new_event_loop()
        asyncio.set_event_loop(loop)
        enhanced_messages = loop.run_until_complete(self.integration.enhance_messages_with_graphiti_context(
            messages=TEST_MESSAGES,
            query="Python libraries"
        ))
...
class TestPydanticModels(unittest.TestCase):
    ...
    def test_openrouter_completion_response(self):
        ...
        self.assertEqual(content, "I can definitely help you with Python! What would you like to know?")
        
        # Test to_atlaschat_format method
        atlaschat_format = response.to_atlaschat_format()
        self.assertEqual(atlaschat_format["content"], 
                         "I can definitely help you with Python! What would you like to know?")
...
async def test_full_integration():
    ...
    client.format_openrouter_response = MagicMock(return_value={
        "content": "I can definitely help you with Python! What would you like to know?",
        "role": "assistant"
    })
