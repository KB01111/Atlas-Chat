    ...
    for endpoint in endpoints:
        ...
        try:
            ...
            if response.status_code == endpoint["expected_status"]:
                ...
                logger.warning(f"❌ Status code: {response.status_code}, expected: {endpoint['expected_status']}")
                continue
            ...
            if endpoint["expected_content_type"] in content_type:
                ...
                logger.warning(f"❌ Content type: {content_type}, expected: {endpoint['expected_content_type']}")
                continue
    ...
    for case in test_cases:
        ...
        try:
            ...
            if response.status_code == case["expected_status"]:
                ...
                logger.warning(f"❌ Status code: {response.status_code}, expected: {case['expected_status']}")
                continue
        ...
        try:
            ...
            try:
                ...
                if isinstance(data, list) and data:
                    ...
                    item = data[0]
                    missing_fields = [field for field in endpoint["expected_fields"] if field not in item]
                ...
                logger.info(f"✅ Response contains all expected fields")
                success_count += 1
